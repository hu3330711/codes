pro get_density_plasmapause_new,yy,mm,dd,sc,exist=exist
  exist=0
  ...
  if exist ne 0 then begin
    ...
    index=where(pp.y eq 1 and (density.y ge 1390*(3/dl.y)^4.83 or density.y ge 300) and finite(density.y),count)
