...
;$URL: svn+ssh://thmsvn@ambrosia.ssl.berkeley.edu/repos/thmsoc/tags/tdas_8_00/idl/themis/thm_ui_new/utilities/thm_ui_wavelet.pro $
;-
...
;          display_object = obj_new('thm_ui_dprint_display',historyWin=hwin,statusBar=sBar)
