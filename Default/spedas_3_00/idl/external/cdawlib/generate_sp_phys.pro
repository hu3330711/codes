...
s=draw_inventory(a,TITLE='SPACE PHYSICS 1960-2029', /BIGPLOT,$
GIF='/home/cdaweb/metadata/sp_phys_cdfmetafile.gif', $
/long_line, /wide_margin, $
START_TIME='1960/01/01 00:00:00',STOP_TIME='2029/12/31 23:59:59',debug=debug)
;
;   Now every 5 years:
;
a=aa
...
GIF='/var/www/cdaweb/htdocs/sp_phys/avail_2015-2019.gif', $
/long_line, /wide_margin, $
...
GIF='/var/www/cdaweb/htdocs/sp_phys/avail_2020-2024.gif', $
/long_line, /wide_margin, $
...
GIF='/var/www/cdaweb/htdocs/sp_phys/avail_2025-2029.gif', $
/long_line, /wide_margin, $
