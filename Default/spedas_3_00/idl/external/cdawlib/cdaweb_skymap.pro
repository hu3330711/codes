;author: $
;Date: 2015/08/17 16:17:36 $
;Header: /home/cdaweb/dev/control/RCS/cdaweb_skymap.pro,v 1.9 2015/08/17 16:17:36 kovalick Exp kovalick $
;Locker: kovalick $
;Revision: 1.9 $ 
;+------------------------------------------------------------------------
; NAME: CDAWeb_Skymap
...
;    purple = 253
    purple = 203 ; in CDAWeb using yellow because purple clashes w/ data
;    tvlct, 180, 120, 200, purple
    tvlct, 180, 120, 213, purple  ; TJK guessing 200 needs to be raised
    for i = 0, n_elements(l)-1 do $
      for j = 0, n_elements(flon)-1 do begin 
        if flon[j] eq 0 then ccolor = 254 $ ;254 is red in CDAWeb
