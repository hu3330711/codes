;Author: johnson $
;Date: 2013/09/06 16:00:49 $
;Header: /home/cdaweb/dev/control/RCS/combined_subtitle.pro,v 1.18 2013/09/06 16:00:49 johnson Exp kovalick $
;Locker: kovalick $
;Revision: 1.18 $
;+------------------------------------------------------------------------
...
web_code='CDAWeb'
len = strlen(title)
if (len gt 73) then sizechar = 1.0 else sizechar = 1.5
if keyword_set(ps) then begin
  ; xyouts,!d.x_size/2,!d.y_size-4*!d.y_ch_size,title,/DEVICE,ALIGNMENT=0.5
endif else begin  
   xyouts,!d.x_size/2,!d.y_size-!d.y_ch_size,title,/DEVICE,ALIGNMENT=0.5,charsize=sizechar
endelse
