;Author: johnson $
;Date: 2016/12/12 17:39:20 $
;Header: /home/cdaweb/dev/control/RCS/plot_maps.pro,v 1.35 2016/12/12 17:39:20 johnson Exp ryurow $
;Locker: ryurow $
;Revision: 1.35 $
;+------------------------------------------------------------------------
; NAME: PLOT_MAPS
...
if (b[0] ne -1) then begin
   ...
   label=lnlabel+" Radial Trace in Geographic Coord."
...
if (b[0] ne -1) then begin
   ...
   label=lnlabel+" North B Trace in Geographic Coord."
   if count le 0 then message, 'No data selected'
   ; plot cdf generated traces
   xyzmap,epoch,lat,lon,alt,cstation,vlat=vlat,iproj=iproj,limit=limit,$
      latdel=latdel,londel=londel,Ttitle=thetitle,$
...
if (b[0] ne -1) then begin
   ...
   label=lnlabel+" South B Trace in Geographic Coord."
   if count le 0 then message, 'No data selected'
   ; plot cdf generated traces
   xyzmap,epoch,lat,lon,alt,cstation,vlat=vlat,iproj=iproj,limit=limit,$
      latdel=latdel,londel=londel,Ttitle=thetitle,$
...
if (b[0] ne -1) then begin
   ...
   label=lnlabel+" Radial Trace in Geomagnetic Coord."
   if count le 0 then message, 'No data selected'
   ; plot cdf generated traces
   xyzmap,epoch,lat,lon,alt,cstation,vlat=vlat,iproj=iproj,limit=limit,$
      latdel=latdel,londel=londel,Ttitle=thetitle,$
...
if (b[0] ne -1) then begin
   ...
   label=lnlabel+" North B Trace in Geomagnetic Coord."
   if count le 0 then message, 'No data selected'
   ; plot cdf generated traces
   xyzmap,epoch,lat,lon,alt,cstation,vlat=vlat,iproj=iproj,limit=limit,$
      latdel=latdel,londel=londel,Ttitle=thetitle,$
...
if (b[0] ne -1) then begin
   ...
   label=lnlabel+" South B Trace in Geomagnetic Coord."
   if count le 0 then message, 'No data selected'
   ; plot cdf generated traces
   xyzmap,epoch,lat,lon,alt,cstation,vlat=vlat,iproj=iproj,limit=limit,$
      latdel=latdel,londel=londel,Ttitle=thetitle,$
...
if (b[0] ne -1) then begin
   ...
   label=lnlabel+" Radial Trace in Solar Magnetic Coord."
   if count le 0 then message, 'No data selected'
   ; plot cdf generated traces
   xyzmap,epoch,lat,lon,alt,cstation,vlat=vlat,iproj=iproj,limit=limit,$
      latdel=latdel,londel=londel,Ttitle=thetitle,$
