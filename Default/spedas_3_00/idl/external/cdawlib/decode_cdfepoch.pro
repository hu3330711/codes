;Author: johnson $
;Date: 2013/09/06 16:07:39 $
;Header: /home/cdaweb/dev/control/RCS/decode_CDFEPOCH.pro,v 1.7 2013/09/06 16:07:39 johnson Exp johnson $
;Locker: johnson $
;Revision: 1.7 $
;+------------------------------------------------------------------------
...
case 1 of
   ...
   keyword_set(epoch16): begin
      CDF_EPOCH16,etime,Yr,Mo,Day,Hr,Min,Sec,Mil,usec,nsec,psec,/BREAKDOWN_EPOCH 
         ...
         estr1 = estr1 + strtrim(string(Min,FORMAT='(I2.2)'),2) + ':'
         estr1 = estr1 + strtrim(string(Sec,FORMAT='(I2.2)'),2) + '.'
         estr1 = estr1 + strtrim(string(mil,FORMAT='(I3.2)'),2) + '.'
         estr1 = estr1 + strtrim(string(usec,FORMAT='(I3.2)'),2) + '.'
         estr1 = estr1 + strtrim(string(nsec,FORMAT='(I3.2)'),2) + '.'
         estr1 = estr1 + strtrim(string(psec,FORMAT='(I3.2)'),2) 
   end
   else: begin
