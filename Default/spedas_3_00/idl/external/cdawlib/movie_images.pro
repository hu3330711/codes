;Author: johnson $ 
;Date: 2015/07/23 17:37:32 $
;Header: /home/cdaweb/dev/control/RCS/movie_images.pro,v 1.30 2015/07/23 17:37:32 johnson Exp kovalick $
;Locker: kovalick $
;Revision: 1.30 $
;+------------------------------------------------------------------------
; NAME: MOVIE_IMAGES
...
;TJK 7/12/2017 - increase to 1000 for testing
  ...
  if(n_images gt 1000 and LIMIT) then begin
   ...
   print, 'STATUS= Movies are limited to 1000 frames, select a shorter time range.'
   return, -1
  endif
