...
;$URL: svn+ssh://thmsvn@ambrosia.ssl.berkeley.edu/repos/spdsoft/tags/spedas_3_00/projects/mms/common/load_data/mms_load_data.pro $
;-
    ...
    for datatype_idx = 0, n_elements(datatypes)-1 do begin
        ...
        if is_string(data_file) then begin
            ...
            for file_idx = 0, num_filenames-1 do begin
                ...
                ; directories
                dir_path = data_rate eq 'brst' ? '/YYYY/MM' : '/YYYY/MM'   ;X.C. Shen changed it from '/YYYY/MM/DD' : '/YYYY/MM'
