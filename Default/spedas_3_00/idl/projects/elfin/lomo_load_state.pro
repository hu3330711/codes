...
;--------------------------------------------------------------------------------------
;-
PRO lomo_load_state,trange=trange
...
;trange=timerange()
  ...
  for i = 0,5 do begin
    ...
    ;stop
    for j = 0,23  do begin
      remote_file = !elf.remote_data_dir + 'bi/' + date + '/nav_coord-' + strmid(date0,2) + '-' + hrs[j] + '.dat'
      local_file = !elf.local_data_dir + 'bi/' + date0 + '/nav_coord-' + strmid(date0,2) + '-' + hrs[j] + '.dat'
print, remote_file
print, local_file
;stop
