...
;  
;  notperhz: if set, wave power will not be calculated to per Hz
;  
;OUTPUTS:
...
; $URL: svn+ssh://thmsvn@ambrosia.ssl.berkeley.edu/repos/spdsoft/tags/spedas_3_00/general/science/wavpol/twavpol.pro $
;-
