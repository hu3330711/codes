...
; $URL: svn+ssh://thmsvn@ambrosia.ssl.berkeley.edu/repos/spdsoft/tags/spedas_3_00/general/science/wind/tsmooth2.pro $
;-

pro tsmooth2, name_, width, esteps=esteps,overwrite=overwrite, newname=newname, preserve_nans=preserve_nans,edge_truncate=edge_truncate,even=even,median=median, display_object=display_object
; 
...
if keyword_set(overwrite) then newname=name else if keyword_set(newname) then newname=newname else newname = name+'_sm'
