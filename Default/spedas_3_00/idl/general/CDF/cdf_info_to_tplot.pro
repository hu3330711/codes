...
; $URL: svn+ssh://thmsvn@ambrosia.ssl.berkeley.edu/repos/spdsoft/tags/spedas_3_00/general/CDF/cdf_info_to_tplot.pro $
;-
...
;          var_1 = var_2        ;bpif  v.name eq 'thb_sir_001'
     ...
     if keyword_set(var_2) and keyword_set(var_1) then data = {x:tvar.dataptr,y:v.dataptr,v1:var_1.dataptr, v2:var_2.dataptr} $
