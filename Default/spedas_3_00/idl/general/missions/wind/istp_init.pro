...
;$URL: svn+ssh://thmsvn@ambrosia.ssl.berkeley.edu/repos/spdsoft/tags/spedas_3_00/general/missions/wind/istp_init.pro $
;-
...
Endif else begin; use defaults
    ...
    endelse
    !istp.local_data_dir  = root_data_dir() + 'istp/sw/' 
    ;URL is deprecated
