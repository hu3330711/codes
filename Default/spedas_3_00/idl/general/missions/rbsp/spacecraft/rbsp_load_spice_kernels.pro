...
; 
; trange: time range of data to be loaded
;
; Examples:
...
;   $URL: svn+ssh://thmsvn@ambrosia.ssl.berkeley.edu/repos/spdsoft/tags/spedas_3_00/general/missions/rbsp/spacecraft/rbsp_load_spice_kernels.pro $
;-


pro rbsp_load_spice_kernels, verbose = verbose, unload=unload, all=all,trange=trange
...
rbsp_load_spice_metakernel,files[0],unload=unload,all=all,trange=trange
