...
;   $URL: svn+ssh://thmsvn@ambrosia.ssl.berkeley.edu/repos/spdsoft/tags/spedas_3_00/general/missions/rbsp/ect/rbsp_load_ect_l3.pro $
;
;-
...
pro rbsp_load_ect_l3,probe,type,get_support_data=get_support_data
  ...
  for p=0,size(p_var,/n_elements)-1 do begin
    ...
    if type eq 'mageis' then begin
      ...
      local_path=!rbsp_ect.local_data_dir+ rbspx+'mageis/L3/',$
       /last_version)
