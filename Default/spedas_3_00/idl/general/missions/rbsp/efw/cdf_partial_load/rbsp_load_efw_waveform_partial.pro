...
; $URL: svn+ssh://thmsvn@ambrosia.ssl.berkeley.edu/repos/spdsoft/tags/spedas_3_00/general/missions/rbsp/efw/cdf_partial_load/rbsp_load_efw_waveform_partial.pro $
;-
