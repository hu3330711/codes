...
; $URL: svn+ssh://thmsvn@ambrosia.ssl.berkeley.edu/repos/spdsoft/tags/spedas_3_00/general/missions/rbsp/efw/rbsp_interp_spin_phase.pro $
;
;-
...
if ~tvar_exist(tphase) then begin
...
if ~tvar_exist(tumbra_sta) or ~tvar_exist(tumbra_end) then begin
