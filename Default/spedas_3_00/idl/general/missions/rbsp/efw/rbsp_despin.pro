...
;   c: (In, optional) Spin period tplot data. By default, 
...
; $URL: svn+ssh://thmsvn@ambrosia.ssl.berkeley.edu/repos/spdsoft/tags/spedas_3_00/general/missions/rbsp/efw/rbsp_despin.pro $
;
;-
...
if ~tvar_exist(pertvar) then begin
...
if phase[0] eq -1 then begin
  write_log,'no enough phase data'
  return
endif
; print, 'nb = ', nb
; stop
