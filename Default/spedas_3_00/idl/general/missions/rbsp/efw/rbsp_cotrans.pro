...
; $URL: svn+ssh://thmsvn@ambrosia.ssl.berkeley.edu/repos/spdsoft/tags/spedas_3_00/general/missions/rbsp/efw/rbsp_cotrans.pro $
;
;-
...
;       dprint, verbose = verbose, 'GSE -> GSM...'
  ...
  'gse2dsc': begin 
      if ~tvar_exist(mat_dsc) then begin
        dprint, 'ERROR: ' + $
